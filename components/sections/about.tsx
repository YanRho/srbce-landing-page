    ...
    <section id="about" className="py-16 bg-white text-gray-900 relative">
      <div className="container mx-auto flex flex-col lg:flex-row items-center px-4 lg:px-16 gap-8">
        ...
        <div className="lg:w-2/3 space-y-8">
          ...
          <p className="text-lg leading-relaxed">
            Our{" "}
            <span className="font-bold text-gradient text-2xl">Mission</span> is
            to redefine the construction landscape through unwavering dedication
          ...
          <p className="text-lg leading-relaxed">
            We{" "}
            <span className="font-bold text-gradient text-2xl">envision</span> a
            future where our name resonates as the epitome of excellence in the
